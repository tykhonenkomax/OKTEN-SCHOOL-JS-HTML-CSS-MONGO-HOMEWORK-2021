...
// ---№ 2 валидую что собачка не может быть первой----------------------------------------------------------------------
...
// ---№ 2 собачка находится на растоянии двух сиволов от точки----------------------------------------------------------
let earNearDot =(a)=> {
...
// ---№ 3 валидую одной двух или тех букв после точки-------------------------------------------------------------------

let dotValidetion =(a)=> {
    if ((a.indexOf('.') === 2) || (a.indexOf('.') === 3) || (a.indexOf('.') === 1)) {
        return 1}
    else {return 0}
}
